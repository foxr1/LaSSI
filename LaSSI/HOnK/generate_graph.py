...
def generate_honk_graph(p:HOnK, data_path:str, result_path:str=None):
    ...
    causal_signal_verb_T = p.create_class("CausalSignalVerb", "CausativeVerb")
    reporting_verb_T = p.create_class("ReportingVerb", "Verb")
    lifecycle_outcome_verb_T = p.create_class("LifecycleOutcomeVerb", "Verb")
    ...
    load_optional_from_txt_file(p, os.path.join(data_path, "verbs", "causal_signal_verbs.txt"), ["Verb", "CausativeVerb", "CausalSignalVerb"], to_reject)
    load_optional_from_txt_file(p, os.path.join(data_path, "verbs", "reporting_verbs.txt"), ["Verb", "ReportingVerb"], to_reject)
    load_optional_from_txt_file(p, os.path.join(data_path, "verbs", "lifecycle_outcome_verbs.txt"), ["Verb", "LifecycleOutcomeVerb"], to_reject)
